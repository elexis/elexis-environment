...
$KCADM update clients/$SOLR_OPENID_CLIENTID -r ElexisEnvironment -s enabled=false -s baseUrl=https://$EE_HOSTNAME/solr/ -s bearerOnly=true -s description='Solr (Only used to define client roles - keep disabled)'
