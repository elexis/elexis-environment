...
MYSQL_STRING="INSERT INTO CONFIG(lastupdate, param, wert) VALUES ('${LASTUPDATE}','EE_RC_ES_INTEGRATION_WEBHOOK_TOKEN', '${TOKEN}') ON DUPLICATE KEY UPDATE wert = '${TOKEN}', lastupdate='${LASTUPDATE}'"
