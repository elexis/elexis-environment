...
-- MDE 27.10.25
-- guacamdmin password and hash deliberatly set to unknown values
...
SELECT
    entity_id,
    decode('31473877774E366764594134', 'hex'),  -- 'guacadmin'
    decode('F4DAABB6E7274B2225D2DA719CBA02488ECE7E97571879479D7941F4A0851972', 'hex'),
    CURRENT_TIMESTAMP,
    true
...
-- MDE 27.10.25
-- Add user graoup guacadmin to implement sso admin group permissions
--- 
INSERT INTO guacamole_entity (name, type) VALUES ('guacadmin', 'USER_GROUP');
INSERT INTO guacamole_user_group (entity_id) 
SELECT entity_id FROM guacamole_entity WHERE name = 'guacadmin' AND guacamole_entity.type = 'USER_GROUP';
